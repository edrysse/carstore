...
<link rel="stylesheet" href="{{ asset('assets/css/responsive.css') }}">
    ...
    <div class="navbar-header">
			                ...
			                <a class="navbar-brand" href="/">Laayoune<span>List</span>Race</a>

			            </div>        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar-menu" aria-controls="navbar-menu" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
            <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
                ...
                @auth
                    <li class="scroll"><a href="{{ url('/dashboard') }}" class="px-4 py-2 text-white bg-[#FF2D20] rounded-md">Dashboard</a></li>
                @else
                    <li class="scroll"><a href="{{ route('login') }}">Log in</a></li>
